...
int main() {
    ...
    string names[10]; int ids[10]; double balances[10];
    ...
    GetInput(inFile, names, ids, balances);
            ...
            case 5: 
                ...
                do {
                    ...
                    for (int i = 0; i < 10; i++) {
                        if (name == names[i]) { 
                            cout << "Found." << endl;
                            SearchName(name, names, ids, balances, outFile);
                            found = true;
                        }
                    }
                    if (!found && name != "done") {
